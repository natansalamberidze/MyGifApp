...
* **UI Framework:** XML Layouts, View Binding, Material Design Components
...
To build and run the project, you will need **Android Studio (Ladybug or newer)** and the **Android SDK**. The project is configured with **Java 17** (`compileSdk = 36`, `minSdk = 24`).
